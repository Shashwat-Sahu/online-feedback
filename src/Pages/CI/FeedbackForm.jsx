...
const FeedbackFormCi = () => {
  ...
  const GetPrevReport = () => {
    ...
    axios
      .get(
        `/ci/getfeedback?service_id=${selectedReport?.service_id}&ci_service_id=${hof?.service_id}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
  ...
  const getHofName = (report) => {
    axios
      .get(`/ci/getHofName?report_hof=${report?.report_hof}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      })
      ...
      <div class="row align-items-start">
        <div class="col-2 col-auto min-vh-100" id="sidebarfeedback-md">
          ...
          <select
            ...
            onChange={(e) => {
              getHofName(reports[e.target.value]);
              setPrevReport([]);
              setSelectedReport(reports[e.target.value]);
              setFormData({
                ...formData,
                "CI's comments": reports[e.target.value].ci_comments,
              });
            }}
          >
        ...
        <div class="col-md-10 offset-md-2 col-xs-12">
          ...
          <div class="mb-2">
            HOF's comments : {selectedReport["hof_comments"]}
          </div>
