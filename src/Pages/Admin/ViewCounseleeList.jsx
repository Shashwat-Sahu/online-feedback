...
const ViewCounseleeList = () => {
  ...
  const handleDelete = (service_id) => {
    axios
      .delete(
        `/counselee/delete?service_id=${service_id}&counsellor_service_id=${counselId}`,
        {
          headers: {
  ...
  useEffect(() => {
    if (show == false || message?.message)
      axios
        .get(
          "/getCounselees?service_id=" + counselId,
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
                    ...
                    <tr>
                      ...
                      <td>
                        <IconButton
                          aria-label="delete"
                          onClick={() => {
                            handleDelete(counselee.service_id);
                          }}
                        >
                          <DeleteIcon />
                        </IconButton>
