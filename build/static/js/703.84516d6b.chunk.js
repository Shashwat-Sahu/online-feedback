/*! For license information please see 703.84516d6b.chunk.js.LICENSE.txt */
(self.webpackChunkonline_feedback =
  self.webpackChunkonline_feedback || []).push([
  [703],
  {
    8703: function (e) {
      e.exports = (function () {
        ...
        function ae() {
          ...
          var ge,
            ...
            dt = function (t) {
              (mt && mt === t) ||
                ...
                (t = I(t)),
                (ge = ge =
                  -1 === ut.indexOf(t.PARSER_MEDIA_TYPE)
                    ? st
                    : t.PARSER_MEDIA_TYPE),
                ...
                (et =
                  "ADD_URI_SAFE_ATTR" in t
                    ? M(I(tt), t.ADD_URI_SAFE_ATTR, ye)
                    : tt),
                (Je =
                  "ADD_DATA_URI_TAGS" in t
                    ? M(I(Qe), t.ADD_DATA_URI_TAGS, ye)
                    : Qe),
                (Xe =
                  "FORBID_CONTENTS" in t ? M({}, t.FORBID_CONTENTS, ye) : Ze),
                ...
                t.ADD_TAGS &&
                  (_e === ke && (_e = I(_e)), M(_e, t.ADD_TAGS, ye)),
                t.ADD_ATTR &&
                  (xe === Le && (xe = I(xe)), M(xe, t.ADD_ATTR, ye)),
                t.ADD_URI_SAFE_ATTR && M(et, t.ADD_URI_SAFE_ATTR, ye),
                t.FORBID_CONTENTS &&
                  (Xe === Ze && (Xe = I(Xe)), M(Xe, t.FORBID_CONTENTS, ye)),
                $e && (_e["#text"] = !0),
          ...
          var Tt = function (e) {
            ...
            xt = function (e) {
              var t;
              if ((kt("beforeSanitizeElements", e, null), St(e)))
                return Nt(e), !0;
              ...
              if (
                ...
                return Nt(e), !0;
              if ("select" === r && O(/<template/i, e.innerHTML))
                return Nt(e), !0;
              if (!_e[r] || Ce[r]) {
                if (!Ce[r] && Ot(r)) {
                  if (
              ...
              return e instanceof u && !Tt(e)
                ...
                : ("noscript" !== r && "noembed" !== r && "noframes" !== r) ||
                  ...
                  ? (Ue &&
                      ...
                      (t = k(t, Te, " ")),
                      e.textContent !== t &&
                        (A(n.removed, { element: e.cloneNode() }),
                        (e.textContent = t))),
            ...
            Lt = function (e, t, n) {
              if (We && ("id" === t || "name" === t) && (n in a || n in ft))
                return !1;
              if (Me && !De[t] && O(Ne, t));
              else if (Re && O(Ee, t));
              else if (!xe[t] || De[t]) {
...
//# sourceMappingURL=703.84516d6b.chunk.js.map
